                                                     ...
                                                     wash_session_status_view_t *wash_session_status_view)
{
    ...
    strncpy(wash_session_status_view->reason_code,
            system_context_last_reason_code(system_context)[0] != '\0' ? system_context_last_reason_code(system_context)
                                                                       : last_transition_record->reason_code,
            sizeof(wash_session_status_view->reason_code) - 1);
    strncpy(wash_session_status_view->global_fault_reason, system_context_private_global_fault_reason(system_context),
