    ...
    const char *reason_code)
{
    ...
    write_projection_field(runtime_result_projection->latest_result_code,
        sizeof(runtime_result_projection->latest_result_code),
        result_code);
    write_projection_field(runtime_result_projection->latest_reason_code,
        sizeof(runtime_result_projection->latest_reason_code),
        reason_code);
}
    ...
    runtime_event_log_kind_t runtime_event_log_kind)
{
    ...
    write_projection_field(runtime_result_projection->entity_id,
        sizeof(runtime_result_projection->entity_id),
        entity_id);
    write_projection_field(runtime_result_projection->previous_state,
        sizeof(runtime_result_projection->previous_state),
        previous_state);
    write_projection_field(runtime_result_projection->current_state,
        sizeof(runtime_result_projection->current_state),
        current_state);
    write_projection_field(runtime_result_projection->transition_result_code,
        sizeof(runtime_result_projection->transition_result_code),
        result_code);
    write_projection_field(runtime_result_projection->transition_reason_code,
        sizeof(runtime_result_projection->transition_reason_code),
        reason_code);
}
