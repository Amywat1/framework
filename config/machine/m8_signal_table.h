...
/*  sig_id                  io_id                 active_low  trig  rel  evt_active              evt_inactive           alarm_code */
    ...
    { M8_SIG_GANTRY_FWD_LIM, DI_GANTRY_FWD_LIMIT,  false,      3U,   3U,  EVT_HW_GANTRY_FWD_LIM, EVT_NONE,              ALARM_CODE_GANTRY_FWD_LIM },
    { M8_SIG_GANTRY_REV_LIM, DI_GANTRY_REAR_LIMIT, false,      3U,   3U,  EVT_HW_GANTRY_REV_LIM, EVT_NONE,              ALARM_CODE_GANTRY_REV_LIM },
    { M8_SIG_LIFT_UP_LIM,    DI_TOP_LIFT_UP,       false,      3U,   3U,  EVT_HW_LIFT_UP_LIM,    EVT_NONE,              ALARM_CODE_LIFT_UP_LIM    },
    { M8_SIG_LIFT_DOWN_LIM,  DI_TOP_LIFT_DOWN,     false,      3U,   3U,  EVT_HW_LIFT_DOWN_LIM,  EVT_NONE,              ALARM_CODE_LIFT_DOWN_LIM  },
};
