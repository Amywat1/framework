...
| `domain/safety/`、`application/bridges/alarm_*`、`application/bridges/estop_alarm_bridge.*`、`application/ports/inbound/safety/`、`domain/ports/outbound/safety/` | `domain/报警系统模块设计.md` |
