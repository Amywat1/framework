...
int main(void)
{
    ...
    TEST_ASSERT(device_runtime_private_runtime_mutable()->global_fault_present == true);
    TEST_ASSERT(device_runtime_private_runtime_mutable()->global_fault_code[sizeof(device_runtime_private_runtime_mutable()->global_fault_code) - 1] == '\0');
    TEST_ASSERT(strlen(device_runtime_private_runtime_mutable()->global_fault_code) == sizeof(long_fault_code) - 1);
    TEST_ASSERT(strcmp(device_runtime_private_runtime_mutable()->global_fault_code, long_fault_code) == 0);
