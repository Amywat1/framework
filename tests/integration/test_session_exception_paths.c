...
static int verify_stop_path(void)
{
    ...
    TEST_ASSERT(strcmp(device_runtime_private_runtime_mutable()->last_reason_code, "integration-stop") == 0);
...
static int verify_fault_path(void)
{
    ...
    TEST_ASSERT(result.ok);
    TEST_ASSERT(device_runtime_private_runtime_mutable()->wash_session.session_state == SESSION_STATE_ABORTED);
    TEST_ASSERT(device_runtime_private_runtime_mutable()->wash_session.final_session_result == RESULT_CODE_SAFE_STOP);
    TEST_ASSERT(device_runtime_private_runtime_mutable()->wash_execution.execution_result == EXECUTION_RESULT_FAULTED);
    TEST_ASSERT(strcmp(device_runtime_private_runtime_mutable()->last_result_code, "aborted") == 0);
    TEST_ASSERT(strcmp(device_runtime_private_runtime_mutable()->last_reason_code, "fault-e-stop") == 0);
...
static int verify_timeout_path(void)
{
    ...
    TEST_ASSERT(result.ok);
    TEST_ASSERT(device_runtime_private_runtime_mutable()->wash_session.session_state == SESSION_STATE_ABORTED);
    TEST_ASSERT(device_runtime_private_runtime_mutable()->wash_session.final_session_result == RESULT_CODE_SEGMENT_TIMEOUT);
    TEST_ASSERT(device_runtime_private_runtime_mutable()->wash_execution.execution_result == EXECUTION_RESULT_SEGMENT_TIMEOUT);
    TEST_ASSERT(strcmp(device_runtime_private_runtime_mutable()->last_result_code, "aborted") == 0);
...
static int verify_idle_fault_clear_path(void)
{
    ...
    TEST_ASSERT(strcmp(device_runtime_private_runtime_mutable()->last_transition_record.reason_code, "global_fault_recorded") == 0);
    ...
    TEST_ASSERT(result.ok);
    TEST_ASSERT(!device_runtime_private_runtime_mutable()->global_fault_present);
    TEST_ASSERT(device_runtime_private_runtime_mutable()->wash_session.session_state == SESSION_STATE_NONE);
    TEST_ASSERT(device_runtime_private_runtime_mutable()->device_state == DEVICE_STATE_STOPPED);
