...
static int verify_formal_start_rejects_unavailable_program_from_idle(void)
{
    ...
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_reason_code, "program_unavailable") == 0);
    ...
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_transition_record.reason_code, "program_unavailable") == 0);
    TEST_ASSERT(device_runtime_private_runtime(system_context)->device_state == DEVICE_STATE_IDLE);
...
static int verify_formal_start_rejects_invalid_program_from_idle(void)
{
    ...
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_result_code, "rejected") == 0);
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_reason_code, "program_invalid") == 0);
    TEST_ASSERT(device_runtime_private_runtime(system_context)->last_transition_record.trigger_type == TRIGGER_TYPE_START);
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_transition_record.result_code, "rejected") == 0);
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_transition_record.reason_code, "program_invalid") == 0);
    TEST_ASSERT(device_runtime_private_runtime(system_context)->device_state == DEVICE_STATE_IDLE);
...
static int verify_formal_start_rejects_when_global_fault_active_from_idle(void)
{
    ...
    device_runtime_private_set_global_fault(system_context, "E_STOP", "forced-global-fault");
    device_runtime_private_set_device_state(system_context, DEVICE_STATE_IDLE);
    ...
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_result_code, "rejected") == 0);
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_reason_code, "global_fault_active") == 0);
    TEST_ASSERT(device_runtime_private_runtime(system_context)->last_transition_record.trigger_type == TRIGGER_TYPE_START);
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_transition_record.result_code, "rejected") == 0);
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_transition_record.reason_code, "global_fault_active") == 0);
    TEST_ASSERT(device_runtime_private_runtime(system_context)->device_state == DEVICE_STATE_IDLE);
...
static int verify_formal_start_rejects_when_running_session_exists(void)
{
    ...
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_result_code, "rejected") == 0);
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_reason_code, "running_session_exists") == 0);
    TEST_ASSERT(device_runtime_private_runtime(system_context)->last_transition_record.trigger_type == TRIGGER_TYPE_START);
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_transition_record.result_code, "rejected") == 0);
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->last_transition_record.reason_code, "running_session_exists") == 0);
    TEST_ASSERT(device_runtime_private_runtime(system_context)->wash_session.session_state == SESSION_STATE_RUNNING);
