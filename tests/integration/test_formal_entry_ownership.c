...
static int verify_formal_start_rejects_unavailable_program_from_idle(void)
{
    ...
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_reason_code, "program_unavailable") == 0);
    ...
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_transition_record.reason_code, "program_unavailable") == 0);
    TEST_ASSERT(control_context_private_runtime_mutable()->device_state == DEVICE_STATE_IDLE);
...
static int verify_formal_start_rejects_invalid_program_from_idle(void)
{
    ...
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_result_code, "rejected") == 0);
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_reason_code, "program_invalid") == 0);
    TEST_ASSERT(control_context_private_runtime_mutable()->last_transition_record.trigger_type == TRIGGER_TYPE_START);
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_transition_record.result_code, "rejected") == 0);
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_transition_record.reason_code, "program_invalid") == 0);
    TEST_ASSERT(control_context_private_runtime_mutable()->device_state == DEVICE_STATE_IDLE);
...
static int verify_formal_start_rejects_when_global_fault_active_from_idle(void)
{
    ...
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_result_code, "rejected") == 0);
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_reason_code, "global_fault_active") == 0);
    TEST_ASSERT(control_context_private_runtime_mutable()->last_transition_record.trigger_type == TRIGGER_TYPE_START);
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_transition_record.result_code, "rejected") == 0);
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_transition_record.reason_code, "global_fault_active") == 0);
    TEST_ASSERT(control_context_private_runtime_mutable()->device_state == DEVICE_STATE_IDLE);
...
static int verify_formal_start_rejects_when_running_session_exists(void)
{
    ...
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_result_code, "rejected") == 0);
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_reason_code, "running_session_exists") == 0);
    TEST_ASSERT(control_context_private_runtime_mutable()->last_transition_record.trigger_type == TRIGGER_TYPE_START);
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_transition_record.result_code, "rejected") == 0);
    TEST_ASSERT(strcmp(control_context_private_runtime_mutable()->last_transition_record.reason_code, "running_session_exists") == 0);
    TEST_ASSERT(control_context_private_runtime_mutable()->wash_session.session_state == SESSION_STATE_RUNNING);
