...
int main(void)
{
    ...
    TEST_ASSERT(strcmp(device_runtime_private_runtime(system_context)->wash_execution.segment_id, "roof_segment") == 0);
    ...
    TEST_ASSERT(device_runtime_private_runtime(system_context)->wash_execution.state == SEGMENT_LIFECYCLE_ENTERING);
