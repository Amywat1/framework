...
int main(void)
{
    ...
    strncpy(snapshot_id, system_context_private_runtime(system_context)->program_snapshot.program_snapshot_id, sizeof(snapshot_id) - 1);
    ...
    TEST_ASSERT(result.ok);
    TEST_ASSERT(system_context_private_runtime(system_context)->program_snapshot.program_snapshot_id[0] == '\0');
    TEST_ASSERT(system_context_private_runtime(system_context)->program_snapshot.validation_result
