...
engine_program_t *engine_program_clone(const engine_program_t *src)
{
    ...
    if (src->interlock_count > 0U) {
        dst->interlocks = (engine_interlock_t *)calloc(src->interlock_count, sizeof(engine_interlock_t));
...
bool engine_direction_from_str(const char *s, engine_direction_t *out)
{
    ...
    if (strcmp(s, "forward") == 0) {
        *out = ENGINE_DIR_FORWARD;
        return true;
    }
    if (strcmp(s, "backward") == 0) {
        *out = ENGINE_DIR_BACKWARD;
        return true;
    }
    return false;
}
...
bool engine_error_strategy_from_str(const char *s, engine_error_strategy_t *out)
{
    ...
    if (strcmp(s, "halt_phase") == 0) {
        *out = ENGINE_ERR_HALT_PHASE;
        return true;
    }
    if (strcmp(s, "skip") == 0) {
        *out = ENGINE_ERR_SKIP;
    ...
    if (strcmp(s, "degrade") == 0) {
        *out = ENGINE_ERR_DEGRADE;
        return true;
    }
    return false;
}
...
bool engine_interlock_action_from_str(const char *s, engine_interlock_action_t *out)
{
    ...
    if (strcmp(s, "halt_all") == 0) {
        *out = ENGINE_ILK_HALT_ALL;
        return true;
    }
    if (strcmp(s, "halt_phase") == 0) {
        *out = ENGINE_ILK_HALT_PHASE;
        return true;
    }
    if (strcmp(s, "custom_action") == 0) {
        *out = ENGINE_ILK_CUSTOM;
        return true;
    }
    return false;
}
...
bool engine_edge_from_str(const char *s, engine_edge_t *out)
{
    ...
    if (strcmp(s, "rising") == 0) {
        *out = ENGINE_EDGE_RISING;
        return true;
    }
    if (strcmp(s, "falling") == 0) {
        *out = ENGINE_EDGE_FALLING;
        return true;
    }
    if (strcmp(s, "high") == 0) {
        *out = ENGINE_EDGE_HIGH;
        return true;
    }
    if (strcmp(s, "low") == 0) {
        *out = ENGINE_EDGE_LOW;
...
bool engine_trigger_type_from_str(const char *s, engine_trigger_type_t *out)
{
    ...
    if (strcmp(s, "condition") == 0) {
        *out = ENGINE_TRIG_CONDITION;
        return true;
    }
    if (strcmp(s, "signal") == 0) {
        *out = ENGINE_TRIG_SIGNAL;
        return true;
    }
    return false;
}
...
bool engine_done_type_from_str(const char *s, engine_done_type_t *out)
{
    ...
    if (strcmp(s, "actions_complete") == 0) {
        *out = ENGINE_DONE_ACTIONS_COMPLETE;
        return true;
    }
    if (strcmp(s, "trigger_exit") == 0) {
        *out = ENGINE_DONE_TRIGGER_EXIT;
        return true;
    }
    if (strcmp(s, "signal") == 0) {
        *out = ENGINE_DONE_SIGNAL;
        return true;
    }
...
bool engine_step_type_from_str(const char *s, engine_step_type_t *out)
{
    ...
    if (strcmp(s, "event") == 0) {
        *out = ENGINE_STEP_EVENT;
        return true;
    }
    if (strcmp(s, "control") == 0) {
        *out = ENGINE_STEP_CONTROL;
        return true;
    }
    return false;
}
