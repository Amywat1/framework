...
#ifndef DOMAIN_PORTS_OUTBOUND_STORAGE_ENGINE_PROGRAM_LOADER_PORT_H
#define DOMAIN_PORTS_OUTBOUND_STORAGE_ENGINE_PROGRAM_LOADER_PORT_H
...
#endif /* DOMAIN_PORTS_OUTBOUND_STORAGE_ENGINE_PROGRAM_LOADER_PORT_H */
