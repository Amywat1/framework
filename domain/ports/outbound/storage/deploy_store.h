...
#ifndef DOMAIN_PORTS_OUTBOUND_STORAGE_DEPLOY_STORE_H
#define DOMAIN_PORTS_OUTBOUND_STORAGE_DEPLOY_STORE_H
...
#endif /* DOMAIN_PORTS_OUTBOUND_STORAGE_DEPLOY_STORE_H */
