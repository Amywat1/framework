 ...
 *          业务映射与报警联动由 适配层完成；通道绑定由具体
 *          HAL 组合层提供装配接口，port ops 不承载项目点位绑定。
 */

#ifndef DOMAIN_PORTS_OUTBOUND_HAL_HAL_SENSOR_PORT_H
#define DOMAIN_PORTS_OUTBOUND_HAL_HAL_SENSOR_PORT_H
...
#endif /* DOMAIN_PORTS_OUTBOUND_HAL_HAL_SENSOR_PORT_H */
