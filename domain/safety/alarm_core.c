...
static const alarm_entry_t s_table[] = {
    ...
    /* 通信超时 */
    { ALARM_CODE_MODBUS_GANTRY,  0,   ALARM_LEVEL_WARNING, 0,    ALARM_RECOVER_AUTO,                         "龙门Modbus通信超时" },
    { ALARM_CODE_MODBUS_BRUSH,   0,   ALARM_LEVEL_WARNING, 0,    ALARM_RECOVER_AUTO,                         "刷子Modbus通信超时" },
    /* 云端 */
