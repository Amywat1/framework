...
static sw_err_t sim_stop(void)       { return SW_OK; }
static sw_err_t sim_pause(void)      { return SW_OK; }
...
static sw_err_t sim_volume_up(void)   { return SW_OK; }
static sw_err_t sim_volume_down(void) { return SW_OK; }
