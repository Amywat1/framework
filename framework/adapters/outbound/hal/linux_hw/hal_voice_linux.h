...
#ifndef ADAPTERS_HAL_LINUX_HW_HAL_VOICE_LINUX_H
#define ADAPTERS_HAL_LINUX_HW_HAL_VOICE_LINUX_H
...
/** @brief  注册 hal_voice_linux 实现到 hal_voice_port */
...
#endif /* ADAPTERS_HAL_LINUX_HW_HAL_VOICE_LINUX_H */
