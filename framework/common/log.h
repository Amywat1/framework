...
#define LOG_ERROR(fmt, ...) \
    sw_log_write(SW_LOG_ERROR, "[%s:%d] " fmt, __FILE__, __LINE__, ##__VA_ARGS__)

#define LOG_WARN(fmt, ...) \
    sw_log_write(SW_LOG_WARN, "[%s:%d] " fmt, __FILE__, __LINE__, ##__VA_ARGS__)

#define LOG_INFO(fmt, ...) \
    sw_log_write(SW_LOG_INFO, "[%s:%d] " fmt, __FILE__, __LINE__, ##__VA_ARGS__)

#define LOG_DEBUG(fmt, ...) \
    sw_log_write(SW_LOG_DEBUG, "[%s:%d] " fmt, __FILE__, __LINE__, ##__VA_ARGS__)
