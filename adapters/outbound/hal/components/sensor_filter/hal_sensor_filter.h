...
#ifndef ADAPTERS_OUTBOUND_HAL_COMPONENTS_SENSOR_FILTER_HAL_SENSOR_FILTER_H
#define ADAPTERS_OUTBOUND_HAL_COMPONENTS_SENSOR_FILTER_HAL_SENSOR_FILTER_H
...
#endif /* ADAPTERS_OUTBOUND_HAL_COMPONENTS_SENSOR_FILTER_HAL_SENSOR_FILTER_H */
