...
#ifndef ADAPTERS_OUTBOUND_HAL_COMPONENTS_VFD_MANAGER_HAL_VFD_MANAGER_H
#define ADAPTERS_OUTBOUND_HAL_COMPONENTS_VFD_MANAGER_HAL_VFD_MANAGER_H
...
#endif /* ADAPTERS_OUTBOUND_HAL_COMPONENTS_VFD_MANAGER_HAL_VFD_MANAGER_H */
