...
#ifndef ADAPTERS_OUTBOUND_HAL_PROVIDERS_SNACK_IO_EXP_SNACK_IO_ADAPTER_H
#define ADAPTERS_OUTBOUND_HAL_PROVIDERS_SNACK_IO_EXP_SNACK_IO_ADAPTER_H
...
#endif /* ADAPTERS_OUTBOUND_HAL_PROVIDERS_SNACK_IO_EXP_SNACK_IO_ADAPTER_H */
