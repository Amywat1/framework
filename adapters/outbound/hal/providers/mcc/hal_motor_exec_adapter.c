...
hal_motor_cmd_result_t hal_motor_run_continuous(hal_motor_exec_t *exec,
                                                ...
                                                hal_motor_dir_t   dir)
{
    return from_mcc_result(motor_run_continuous((motor_executor_t *)exec, motor, to_mcc_speed(spd), to_mcc_dir(dir)));
}
                                         ...
                                         const hal_motor_move_spec_t *spec)
{
    ...
    return from_mcc_result(
        motor_move_to((motor_executor_t *)exec, motor, to_mcc_speed(spd), to_mcc_dir(dir), mcc_spec_p));
}
...
hal_motor_cmd_result_t hal_motor_set_speed(hal_motor_exec_t *exec,
                                           ...
                                           hal_motor_dir_t   dir)
{
    return from_mcc_result(motor_set_speed((motor_executor_t *)exec, motor, to_mcc_speed(spd), to_mcc_dir(dir)));
}
...
{
    return from_mcc_result(motor_recover((motor_executor_t *)exec, motor, to_mcc_recovery_step(step)));
}
