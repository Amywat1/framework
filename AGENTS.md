...
当前代码设计需要遵守 /doc/软件设计框架说明.md
修改代码前先了解代码的整体框架设计，保持各代码模块的边界，修改不需要考虑兼容性，这是新项目程序开发阶段，只要有更好的方案就可以替换原方案
...
理由：项目重视可维护、直接可读的实现，而不是为假想未来预支复杂度。
...
## 其它
如果有行业内成熟的库可以调用，就直接调用现成的库，不要再自己重写库代码