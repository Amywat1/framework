...
#define IO_HANDLE_MAKE(kind_, board_, pin_)                                                                            \
    ((uint16_t)((kind_) | ((((uint16_t)(board_)) & 0x7FU) << IO_HANDLE_BOARD_SHIFT)                                    \
...
#ifdef __cplusplus
#define IO_DI(board_, pin_)                                                                                            \
    io_di_t                                                                                                            \
    {                                                                                                                  \
        IO_HANDLE_MAKE(IO_KIND_DI, board_, pin_)                                                                       \
    }
#define IO_DO(board_, pin_)                                                                                            \
    io_do_t                                                                                                            \
    {                                                                                                                  \
        IO_HANDLE_MAKE(IO_KIND_DO, board_, pin_)                                                                       \
    }
#else
