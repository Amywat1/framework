 ...
 *          snack_cloud_adapter.h 两个固定函数指针形状的适配函数，供
 ...
 * @note   匹配 snack_cloud_adapter.h 的 snack_cloud_report_builder_fn_t 形状，
 *         由 wiring.c 注入 snack_cloud_report_adapter_register()
 */
 ...
 * @note   匹配 snack_cloud_adapter.h 的 snack_cloud_cmd_dispatch_fn_t 形状，
 *         由 project_hooks.c 注入 snack_cloud_command_adapter_init()
 */
