 ...
 */
void device_runtime_set_event_logger_port(device_runtime_t system_context,
 ...
 */
const wash_trigger_event_t *device_runtime_pending_trigger_at(const device_runtime_t system_context,
                                                              unsigned int index);
