#ifndef APPLICATION_USE_CASES_FORMAL_COMMAND_H
#define APPLICATION_USE_CASES_FORMAL_COMMAND_H
 ...
 */
void formal_command_format_response(char *response_line, size_t response_line_size,
